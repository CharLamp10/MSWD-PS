...
for s = 1:length(SNR)
    ...
    if exist(fullfile("E:\MSWD_paper_new\parameter_sensitivity_analysis",['sim',num2str(casee),'_MVMD_SNR',num2str(SNR(s)),'.mat']))
        load(fullfile("E:\MSWD_paper_new\parameter_sensitivity_analysis",['sim',num2str(casee),'_MVMD_SNR',num2str(SNR(s)),'.mat']))
    else
    ...
    if ~exist(fullfile("E:\MSWD_paper_new\parameter_sensitivity_analysis",['sim',num2str(casee),'_MVMD_SNR',num2str(SNR(s)),'.mat']))
        save(fullfile("E:\MSWD_paper_new\parameter_sensitivity_analysis",['sim',num2str(casee),'_MVMD_SNR',num2str(SNR(s)),'.mat']),"imfs_MVMD")
    end
    ...
    load(fullfile("simulated",['sim5_SNR',num2str(SNR(s)),'.mat']))
    if exist(fullfile("E:\MSWD_paper_new\parameter_sensitivity_analysis",['sim',num2str(casee),'_MSWD_SNR',num2str(SNR(s)),'.mat']))
        load(fullfile("E:\MSWD_paper_new\parameter_sensitivity_analysis",['sim',num2str(casee),'_MSWD_SNR',num2str(SNR(s)),'.mat']))
    else
    ...
    if ~exist(fullfile("E:\MSWD_paper_new\parameter_sensitivity_analysis",['sim',num2str(casee),'_MSWD_SNR',num2str(SNR(s)),'.mat']))
        save(fullfile("E:\MSWD_paper_new\parameter_sensitivity_analysis",['sim',num2str(casee),'_MSWD_SNR',num2str(SNR(s)),'.mat']),"imfs_MSWD")
    end
    ...
    if save_plots
        exportgraphics(gcf,fullfile(pwd,'plots_PSA',['MVMD_sim',num2str(casee),'_SNR',num2str(SNR(s)),'_NRMSE.png']),'Resolution',1000)
    end
    ...
    c=colorbar('Position',[1 0.001 0.001 0.01]); caxis([minimum+0.2 maximum-0.2])
    if save_plots
        exportgraphics(gcf,fullfile(pwd,'plots_PSA',['MSWD_sim',num2str(casee),'_SNR',num2str(SNR(s)),'_NRMSE.png']),'Resolution',1000)
    end
end
