...
plv_min = min([min(lower_plv_MEMD),min(lower_plv_EWT),min(lower_plv_IRCNN),min(lower_plv_MVMD),min(lower_plv_MSWD),min(true_plv)]);
plv_max = max([max(lower_plv_MEMD),max(lower_plv_EWT),max(lower_plv_IRCNN),max(upper_plv_MVMD),max(upper_plv_MSWD),max(true_plv)]);
